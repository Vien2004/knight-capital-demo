public class TradingSystem {
    ...
    public static void main(String[] args) {
        ...
        int receivedFlag = 1; // Giả lập nhận Flag lỗi [cite: 16]
        executeOrder(receivedFlag);
    }

    public static void executeOrder(int flag) {
        if (flag == 1) {
            activatePowerPegMode(); // Gọi hàm lẽ ra phải xóa từ 8 năm trước [cite: 21, 22]
        }
    }
    ...
    private static void activatePowerPegMode() {
        ...
        while (true) {
            ...
            if (orders > 1000) break; // Dừng sau 1000 lệnh giả lập [cite: 30]
        }
    }
}